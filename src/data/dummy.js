...
export const EditorData = () => (
  <div>
    <h3>
      Harsh Moye
      Certified Meta® Front-end Developer | JavaScript Developer | UX/UI Designer | Final Year Student at Padre Conceicao College of Engineering, Verna (PCCE)
    🚀 Hello there! I'm a final year Computer Engineering student on a mission to create digital magic. Passion runs deep in my veins for crafting experiences that not only catch your eye but also steal your heart. From the foundational building blocks of HTML, SCSS, CSS, and JavaScript to the wizardry of React, Framer Motion, Next.js, Bootstrap, and Tailwind CSS, I've got the tools to weave wonders online.

      And as a Certified Meta Front-End Developer, I bring an extra layer of expertise to the table, ensuring top-notch performance and innovation in every project. But let's talk vibes beyond the code. I'm all about diving deep into user behavior, ensuring every click feels like a smooth sail. Because let's face it, technology isn't just about bits and bytes; it's about sparking real emotions and forging genuine connections.

      Driven by curiosity and armed with a perfectionist's eye, I'm itching to dive into projects where innovation dances hand in hand with functionality. So, ready to turn your digital dreams into dazzling realities? Let's team up and paint the digital canvas with strokes of brilliance!
